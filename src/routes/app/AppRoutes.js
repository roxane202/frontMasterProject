...
import SaisieConsolidation from "../../views/planification/SaisieConsolidation"
import ComposantePoids from "../../views/planification/ComposantePoids"
import SousComposantePoids from "../../views/planification/SousComposantePoids"
...
function guardMyroute(to, from, next) {
  ...
  if (store.state.Utilisateurs.isLoggedIn) isAuthenticated = true;
...
const AuthRoutes = [
  ...
  {
        path: '/SaisieConsolidation',
        name:"SaisieConsolidation",
        beforeEnter : guardMyroute,
        component: SaisieConsolidation
  },
];
