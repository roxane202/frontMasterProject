...
export function getProjet({ commit }) {
  ...
  apiGuest.get('/projet').then(response => {
...
export function ajouterProjet({ commit }, formData) {
  commit("SET_LOADING_PROJET",true)
  apiGuest.post('/projet', formData).then(response => {
...
export function supprimerProjet({ commit }, id) {
      ...
      apiGuest.delete('/projet/' + id).then(() => {
        commit("SET_LOADING_PROJET",false)
        this.$app.$notify({
          title: 'success',
...
export function modificationProjet({ commit }, formData) {
  commit("SET_LOADING_PROJET",true)
  apiGuest.put('/projet', formData).then(response => {
 ...
 */
 ...
 export function getPartiePrenante({ commit }) {
  ...
  apiGuest.get('/partie_prenante').then(response => {
...
export function ajouterPartiePrenante({ commit }, formData) {
  ...
  apiGuest.post('/partie_prenante', formData).then(response => {
    if (response.status == 201) {
...
export function supprimerPartiePrenante({ commit }, id) {
      ...
      apiGuest.delete('/partie_prenante/' + id).then(() => {
        commit("SET_LOADING_PARTIE_PRENANTE_PROJET",false)
        this.$app.$notify({
          title: 'success',
          text: 'Suppression effectuer !',
...
export function modificationPartiePrenanteProjet({ commit }, formData) {
  commit("SET_LOADING_PARTIE_PRENANTE_PROJET",true)
  apiGuest.put('/partie_prenante', formData).then(response => {
 ...
 */
 ...
 export function getTypeResource({ commit }) {
  ...
  apiGuest.get('/type_ressource').then(response => {
...
export function ajouterTypeResource({ commit }, formData) {
  ...
  apiGuest.post('/type_ressource', formData).then(response => {
    if (response.status == 201) {
...
export function supprimerTypeResource({ commit }, id) {
      ...
      apiGuest.delete('/type_ressource/' + id).then(() => {
        commit("SET_LOADING_TYPE_RESOURCE",false)
        this.$app.$notify({
          title: 'success',
          text: 'Suppression effectuer !',
...
export function modificationTypeResource({ commit }, formData) {
  commit("SET_LOADING_TYPE_RESOURCE",true)
  apiGuest.put('/type_ressource', formData).then(response => {
 ...
 */
 ...
 export function getResource({ commit }) {
  ...
  apiGuest.get('/ressource').then(response => {
...
export function ajouterResource({ commit }, formData) {
  ...
  apiGuest.post('/ressource', formData).then(response => {
    if (response.status == 201) {
...
export function supprimerResource({ commit }, id) {
  commit("SET_LOADING_RESOURCE",true)
      ...
      apiGuest.delete('/poids_indicateur/' + id).then(() => {
...
export function modificationResource({ commit }, formData) {
  commit("SET_LOADING_RESOURCE",true)
  apiGuest.put('/ressource', formData).then(response => {
 ...
 */
 ...
 export function getPoidsIndicateur({ commit }) {
  commit("SET_LOADING_POIDS_INDICATEUR",true)
  apiGuest.get('/poids_indicateur').then(response => {
...
export function ajouterPoidsIndicateurs({ commit }, formData) {
  ...
  apiGuest.post('/poids_indicateur', formData).then(response => {
    if (response.status == 201) {
...
export function modificationPoidsIndicateur({ commit }, formData) {
  commit("SET_LOADING_POIDS_INDICATEUR",true)
  apiGuest.put('/poids_indicateur', formData).then(response => {
 ...
 */
 ...
 export function getAutrePartenaire({ commit }) {
  ...
  apiGuest.get('/autre_partenaire').then(response => {
...
export function ajouterAutrePartenaire({ commit }, formData) {
  ...
  apiGuest.post('/autre_partenaire', formData).then(response => {
    if (response.status == 201) {
...
export function supprimerAutrePartenaire({ commit }, id) {
      ...
      apiGuest.delete('/autre_partenaire/' + id).then(() => {
...
export function modificationAutrePartenaire({ commit }, formData) {
  commit("SET_LOADING_AUTRE_PARTENAIRE",true)
  apiGuest.put('/autre_partenaire', formData).then(response => {
 ...
 */
 ...
 export function getNatureIndicateur({ commit }) {
  ...
  apiGuest.get('/nature_indicateur').then(response => {
...
export function ajouterNatureIndicateur({ commit }, formData) {
  ...
  apiGuest.post('/nature_indicateur', formData).then(response => {
    if (response.status == 201) {
...
export function supprimerNatureIndicateur({ commit }, id) {
      ...
      apiGuest.delete('/nature_indicateur/' + id).then(() => {
        commit("SET_LOADING_NATURE_INDICATEUR",false)
        this.$app.$notify({
          title: 'success',
          text: 'Suppression effectuer !',
...
export function modificationNatureIndicateur({ commit }, formData) {
  commit("SET_LOADING_NATURE_INDICATEUR",true)
  apiGuest.put('/nature_indicateur', formData).then(response => {
 ...
 */
 ...
 export function getBeneficiaire({ commit }) {
  ...
  apiGuest.get('/beneficiaire').then(response => {
...
export function ajouterBeneficiaire({ commit }, formData) {
  ...
  apiGuest.post('/beneficiaire', formData).then(response => {
    if (response.status == 201) {
...
export function supprimerBeneficiaire({ commit }, id) {
      ...
      apiGuest.delete('/beneficiaire/' + id).then(() => {
        commit("SET_LOADING_BENEFICIAIRE",false)
        this.$app.$notify({
          title: 'success',
          text: 'Suppression effectuer !',
...
export function modificationBeneficiaire({ commit }, formData) {
  commit("SET_LOADING_BENEFICIAIRE",true)
  apiGuest.put('/beneficiaire', formData).then(response => {
 ...
 */
 ...
 export function getTypeMarche({ commit }) {
  ...
  apiGuest.get('/type_marche').then(response => {
...
export function ajouterTypeMarche({ commit }, formData) {
  ...
  apiGuest.post('/type_marche', formData).then(response => {
    if (response.status == 201) {
...
export function supprimerTypeMarche({ commit }, id) {
      ...
      apiGuest.delete('/type_marche/' + id).then(() => {
        commit("SET_LOADING_TYPE_MARCHE",false)
        this.$app.$notify({
          title: 'success',
          text: 'Suppression effectuer !',
...
export function modificationTypeMarche({ commit }, formData) {
  commit("SET_LOADING_TYPE_MARCHE",true)
  apiGuest.put('/type_marche', formData).then(response => {
 ...
 */
 ...
 export function getMethodePassation({ commit }) {
  ...
  apiGuest.get('/mode_passation').then(response => {
...
export function ajouterMethodePassation({ commit }, formData) {
  ...
  apiGuest.post('/mode_passation', formData).then(response => {
    if (response.status == 201) {
...
export function supprimerMethodePassation({ commit }, id) {
      ...
      apiGuest.delete('/mode_passation/' + id).then(() => {
        commit("SET_LOADING_METHODE_PASSATION_MARCHE",false)
        this.$app.$notify({
          title: 'success',
          text: 'Suppression effectuer !',
...
export function modificationMethodePassation({ commit }, formData) {
  commit("SET_LOADING_METHODE_PASSATION_MARCHE",true)
  apiGuest.put('/mode_passation', formData).then(response => {
 ...
 */
 ...
 export function getFournisseur({ commit }) {
  ...
  apiGuest.get('/fournisseur').then(response => {
...
export function ajouterFournisseur({ commit }, formData) {
  ...
  apiGuest.post('/fournisseur', formData).then(response => {
    if (response.status == 201) {
...
export function supprimerFournisseur({ commit }, id) {
      ...
      apiGuest.delete('/fournisseur/' + id).then(() => {
        commit("SET_LOADING_FOURNISSEUR",false)
        this.$app.$notify({
          title: 'success',
          text: 'Suppression effectuer !',
...
export function modificationFournisseur({ commit }, formData) {
  commit("SET_LOADING_FOURNISSEUR",true)
  apiGuest.put('/fournisseur', formData).then(response => {
 ...
 */
 ...
 export function getDevise({ commit }) {
  ...
  apiGuest.get('/devise').then(response => {
...
export function ajouterDevise({ commit}, formData) {
  ...
  apiGuest.post('/devise', formData).then(response => {
    if (response.status == 201) {
    ...
    //   this.$app.$notify({
    //     title: 'error',
    //     text: "Une erreur c'est produite lors de l'enregistrement veillez verifie",
    //     type:"warning"
    // })
    // }
     else{
...
export function supprimerDevise({ commit }, id) {
  commit("SET_LOADING_DEVISE",true)
      ...
      apiGuest.delete('/devise/' + id).then(() => {
        commit("SET_LOADING_DEVISE",false)
        this.$app.$notify({
          title: 'success',
          text: 'Suppression effectuer !',
...
export function modificationDevise({ commit }, formData) {
  commit("SET_LOADING_DEVISE",true)
  apiGuest.put('/devise', formData).then(response => {
 ...
 */
 ...
 export function getFonctionLocale({ commit }) {
  ...
  apiGuest.get('/fonction_locale').then(response => {
...
export function ajouterFonctionLocale({ commit }, formData) {
  ...
  apiGuest.post('/fonction_locale', formData).then(response => {
    if (response.status == 201) {
...
export function supprimerFonctionLocale({ commit }, id) {
  commit("SET_LOADING_FONCTION_LOCALE",true)
      ...
      apiGuest.delete('/fonction_locale/' + id).then(() => {
        commit("SET_LOADING_FONCTION_LOCALE",false)
        this.$app.$notify({
          title: 'success',
          text: 'Suppression effectuer !',
...
export function modificationFonctionLocale({ commit }, formData) {
  commit("SET_LOADING_FONCTION_LOCALE",true)
  apiGuest.put('/fonction_locale', formData).then(response => {
 ...
 */
 ...
 export function getPosition({ commit }) {
  ...
  apiGuest.get('/position').then(response => {
...
export function ajouterPosition({ commit }, formData) {
  ...
  apiGuest.post('/position', formData).then(response => {
    if (response.status == 201) {
...
export function supprimerPosition({ commit }, id) {
  commit("SET_LOADING_POSITION",true)
      ...
      apiGuest.delete('/position/' + id).then(() => {
        commit("SET_LOADING_POSITION",false)
        this.$app.$notify({
          title: 'success',
          text: 'Suppression effectuer !',
...
export function modificationPosition({ commit }, formData) {
  commit("SET_LOADING_POSITION",true)
  apiGuest.put('/position', formData).then(response => {
...
export function ajouterProjetPartiePrenante({ commit }, formData) {
  ...
  apiGuest.post('/partie_prenantes', formData).then(response => {
    if (response.status == 201) {
...
export function supprimerProjetPartiePrenante({ commit }, id) {
  commit("SET_LOADING_PROJET_PARTIE_PRENANTES",true)
      ...
      apiGuest.delete('/partie_prenantes/' + id).then(() => {
        commit("SET_LOADING_PROJET_PARTIE_PRENANTES",false)
        this.$app.$notify({
          title: 'success',
          text: 'Suppression effectuer !',
...
export function modificationProjetPartiePrenante({ commit }, formData) {
  commit("SET_LOADING_PROJET_PARTIE_PRENANTES",true)
  apiGuest.put('/partie_prenantes', formData).then(response => {
 ...
 */
 ...
 export function getUser({ commit }) {
  commit("SET_LOADING_RESOURCE",true)
  apiGuest.get('/users').then(response => {
...
export function ajouterUser({ commit }, formData) {
  ...
  apiGuest.post('/users', formData).then(response => {
    if (response.status == 201) {
...
//Actions Exigences
 ...
 export function getExigence({ commit }) {
  commit("SET_LOADING_EXIGENCE",true)
  apiGuest.get('/exigence').then(response => {
    commit('GET_EXIGENCE', response.data)
    commit("SET_EXIGENCE",false)
  }).catch(error => {
    console.log(error)
    commit("SET_LOADING_EXIGENCE",false)
  })
}

export function ajouterExigence({ commit }, formData) {
  commit("SET_LOADING_EXIGENCE",true)

  apiGuest.post('/exigence', formData).then(response => {
    if (response.status == 201) {

      commit('AJOUTER_EXIGENCE', response.data)
      ...
      commit("SET_LOADING_EXIGENCE",false)
      commit("SET_ERROR_EXIGENCE",false)
    }

  }).catch(error => {
    console.log(error)
    commit("SET_LOADING_EXIGENCE",false)
    commit("SET_ERROR_EXIGENCE",true)
    if(error.response==undefined){
      this.$app.$notify({
        title: 'error',
        text: "Veuillez verifier votre connexion et réessayer ",
...
export function supprimerExigence({ commit }, id) {

      commit("SET_LOADING_EXIGENCE",true)
      commit('SUPPRIMER_EXIGENCE', id)
      apiGuest.delete('/exigence/' + id).then(() => {
        commit("SET_LOADING_EXIGENCE",false)
        this.$app.$notify({
          title: 'success',
          text: 'Suppression effectuer !',
...
export function modificationExigence({ commit }, formData) {
  commit("SET_LOADING_EXIGENCE",true)
  apiGuest.put('/exigence', formData).then(response => {
    commit('MODIFIER_EXIGENCE', response.data)
    this.$app.$notify({
      title: 'success ',
      text: 'Enregistrement effectué !',
      type: "success"
...
//Actions Partie Prenante Exigence



 export function getPartiePrenanteExigence({ commit }) {
  commit("SET_LOADING_PARTIE_PRENANTES_EXIGENCE",true)
  apiGuest.get('/exigence-partiePrenante').then(response => {
    commit('GET_PARTIE_PRENANTES_EXIGENCE', response.data)
    commit("SET_LOADING_PARTIE_PRENANTES_EXIGENCE",false)
  }).catch(error => {
    console.log(error)
    commit("SET_LOADING_PARTIE_PRENANTES_EXIGENCE",false)
  })
...
export function ajouterPartiePrenanteExigence({ commit }, formData) {
  commit("SET_LOADING_PARTIE_PRENANTES_EXIGENCE",true)

  apiGuest.post('/exigence-partiePrenante', formData).then(response => {
    if (response.status == 201) {

      commit('AJOUTER_PARTIE_PRENANTES_EXIGENCE', response.data)
      ...
      commit("SET_LOADING_PARTIE_PRENANTES_EXIGENCE",false)
      commit("SET_ERROR_PARTIE_PRENANTES_EXIGENCE",false)
    }

  }).catch(error => {
    console.log(error)
    commit("SET_LOADING_PARTIE_PRENANTES_EXIGENCE",false)
    commit("SET_PARTIE_PRENANTES_EXIGENCE",true)
...
export function supprimerPartiePrenanteExigence({ commit }, id) {
  commit("SET_LOADING_PARTIE_PRENANTES_EXIGENCE",true)
      commit('SUPPRIMER_PARTIE_PRENANTES_EXIGENCE', id)
      apiGuest.delete('/exigence-partiePrenante/' + id).then(() => {
        commit("SET_LOADING_PARTIE_PRENANTES_EXIGENCE",false)
        this.$app.$notify({
          title: 'success',
          text: 'Suppression effectuer !',
...
export function modificationPartiePrenanteExigence({ commit }, formData) {
  commit("SET_LOADING_PARTIE_PRENANTES_EXIGENCE",true)
  apiGuest.put('/exigence-partiePrenante', formData).then(response => {
    commit('MODIFIER_PARTIE_PRENANTES_EXIGENCE', response.data)
    this.$app.$notify({
      title: 'success ',
      text: 'Enregistrement effectué !',
      type: "success"
...
//Actions Composantes avec Poids



 export function getComposantePoids({ commit }) {
  commit("SET_LOADING_COMPOSANTE_POIDS",true)
  apiGuest.get('/composante').then(response => {
    commit('GET_COMPOSANTE_POIDS', response.data)
    commit("SET_LOADING_COMPOSANTE_POIDS",false)
  }).catch(error => {
    console.log(error)
    commit("SET_LOADING_COMPOSANTE_POIDS",false)
  })
...
export function ajouterComposantePoids({ commit }, formData) {
  commit("SET_LOADING_COMPOSANTE_POIDS",true)

  apiGuest.post('/composante', formData).then(response => {
    if (response.status == 201) {

      commit('AJOUTER_COMPOSANTE_POIDS', response.data)
      ...
      commit("SET_LOADING_COMPOSANTE_POIDS",false)
      commit("SET_ERROR_COMPOSANTE_POIDS",false)
    }

  }).catch(error => {
    console.log(error)
    commit("SET_LOADING_COMPOSANTE_POIDS",false)
    commit("SET_PARTIE_COMPOSANTE_POIDS",true)
...
export function supprimerComposantePoids({ commit }, id) {
  commit("SET_LOADING_COMPOSANTE_POIDS",true)
      commit('SUPPRIMER_COMPOSANTE_POIDS', id)
      apiGuest.delete('/composante/' + id).then(() => {
        commit("SET_LOADING_COMPOSANTE_POIDS",false)
        this.$app.$notify({
          title: 'success',
          text: 'Suppression effectuer !',
...
export function modificationComposantePoids({ commit }, formData) {
  commit("SET_LOADING_COMPOSANTE_POIDS",true)
  apiGuest.put('/composante', formData).then(response => {
    commit('MODIFIER_COMPOSANTE_POIDS', response.data)
    this.$app.$notify({
      title: 'success ',
      text: 'Enregistrement effectué !',
      type: "success"
 ...
 export function getlisteuser({ commit }) {

  apiGuest.get('/users').then(response => {
    commit('LISTE_USERS', response.data)
