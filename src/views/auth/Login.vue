    ...
    <v-content>
      <v-container fluid fill-height>
        <v-layout align-center justify-center>
          <div class="container_form" id="container">
            <div class="form-container sign-in-container">
              <form action="#">
                ...
                <input
                  type="text"
                  :class="{ 'hasErroInpu': $v.user.email.$error }"
                  v-model="user.email"
                  class="form-control"
                  name="email"
                  tabindex="1"
                ...
                >Veillez entrer votre email</div>
                <input
                  :class="{ 'hasErroInpu': $v.user.password.$error }"
                  type="password"
                  class="form-control"
                ...
                >Veillez entre votre mot de passe</div>
          ...
          <v-dialog v-model="getterLoader" hide-overlay persistent width="300">
