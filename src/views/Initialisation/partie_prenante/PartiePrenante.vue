            ...
            <v-card-text>
              <table id="table-edit" class="table table-hover">
                <tr>
                  ...
                  <td style="background-color: #f7f7f7">Designation</td>
              ...
              <table id="table-edit" class="table table-hover">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      {{ positionPartiePrenante(item.position_actuelle) }}
                    </td>
                    <td>
                      {{ positionPartiePrenante(item.position_future) }}
                    </td>
                  </tr>
                </tbody>
              </table>
                    ...
                    <div class="col-md-4">
                      <div class="form-group">
                        ...
                        <select
                          id="Pour/Contre"
                          class="form-control"
                          v-model="formData.position_actuelle"
                        >
                          <option></option>
                          <option
                            :value="item.id"
                    ...
                    <div class="col-md-4">
                      <div class="form-group">
                        ...
                        <select
                          id="Pour/Contre"
                          class="form-control"
                          v-model="formData.position_future"
                        >
                          <option></option>
                          <option
                            :value="item.id"
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <select
                      id="Pour/Contre"
                      class="form-control"
                      v-model="edite.position_actuelle"
                    >
                      <option></option>
                      <option
                        :value="item.id"
