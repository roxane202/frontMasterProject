            ...
            <template v-slot:expanded-item="{ headers, item }">
              <td :colspan="headers.length">
                    ...
                    <div class="form-group">
                      ...
                      >
                        ...
                        <option
                          ...
                          v-for="projetPartie in partiePrenanteNoExisteToProjet(
                            item.id
                          )"
                          :key="'DFR' + projetPartie.id"
                        >
                          {{ projetPartie.designation }}
                        </option>
                      </select>
                    </div>
                  </div>
                ...
                <table id="table-edit" class="table table-hover">
                  ...
                  <tbody>
                    <tr
                      v-for="partie in listePartiePrenanteProjet(item.id)"
                      :key="partie.id"
                    >
                      <td>{{ partie.code }}</td>
                ...
                <div
                  ...
                  v-if="!listePartiePrenanteProjet(item.id).length"
                >
                ...
                <v-card-text>
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      ...
                      <div class="form-group">
                        <label class="form-label semibold" for="date_debut"
                          >Date début</label
                        >
                        <input
                          type="date"
                          :class="{
                            hasErroInpu: $v.formData.date_debut.$error,
                          }"
                      ...
                      <div class="form-group">
                        ...
                        <input
                          type="text"
                          :class="{
                            hasErroInpu: $v.formData.chef_projet.$error,
                          }"
                      ...
                      <div class="form-group">
                        <label class="form-label semibold" for="devise"
                          >Devise</label
                        >
                        <select
                          id="devise"
                          class="form-control"
                          v-model="formData.devise_id"
                        >
                          <option></option>
                          <option
                            :value="item.id"
                      ...
                      <div class="form-group">
                        ...
                        <money
                          v-model="formData.cout_restant"
                          name="cout_restant"
                          class="form-control"
                          id="cout_restant"
                          placeholder="cout_restant"
                          :class="{
                            hasErroInpu: $v.formData.cout_restant.$error,
                          }"
                        ></money>
                        <div
                          style="color: red"
                          class=""
                          v-if="$v.formData.cout_restant.$error"
                        >
                          Veillez entrer cout_restant
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input
                          type="text"
                          :class="{
                            hasErroInpu: $v.formData.designation.$error,
                          }"
                      ...
                      <div class="form-group">
                        ...
                        <input
                          type="text"
                          :class="{
                            hasErroInpu: $v.formData.commanditaire.$error,
                          }"
                      ...
                      <div class="form-group">
                        <label class="form-label semibold" for="chef_projet"
                          >Budget projet
                          {{ deviseProjet(formData.devise_id) }}</label
                        >
                      ...
                      <div class="form-group">
                        ...
                        <money
                          v-model="formData.cout_reel"
                          name="cout_reel"
                          class="form-control"
                          id="cout_reel"
                          placeholder="cout_reel"
                          :class="{ hasErroInpu: $v.formData.cout_reel.$error }"
                        ></money>
                        <div
                          style="color: red"
                          class=""
                          v-if="$v.formData.cout_reel.$error"
                        >
                          Veillez entrer cout_reel
                        </div>
                      </div>
                    </div>
                  </div>
...
export default {
  ...
  computed: {
    ...
    listePartiePrenanteProjet() {
      return (id) => {
        if (id == null) return [];
        let objetProjetPartiePrenante = this.getterPartiePrenanteProjet.filter(
    ...
    partiePrenanteNoExisteToProjet() {
      return (projet) => {
        ...
        this.getterPartiePrenanteProjet.forEach(function (value) {
          console.log(value);
          let objet = vm.getterPartiePrenanteProjet.find((item) => {
            if (
  ...
  methods: {
    ...
    enregistreProjetPartiePrenante(projet) {
      ...
      this.ajouterPartiePrenante(this.projetPP);
