        ...
        <template v-slot:default="dialog">
          <v-card>
            ...
            <v-card-actions class="justify-end">
              ...
              >Fermer</v-btn>
              <v-btn
                :disabled="getterLoadingBeneficiaire"
                :loading="getterLoadingBeneficiaire"
                class="white--text"
...
<!--DIALOG LOADING--->
        <v-dialog
              v-model="getterLoadingBeneficiaire"
              persistent
              width="250"
              height="200"
            >
     ...
     dialogEdite: false,
      ...
      defaultItem: {
       code: '',
        ...
        computed:{
            ...mapGetters('Application', ['getterBeneficiaire', 'getterLoadingBeneficiaire',"getterErrorBeneficiaire"]),
              formTitle () {
        ...
        methods:{
             ...mapActions('Application', ['ajouterBeneficiaire',"supprimerBeneficiaire","modificationBeneficiaire"]),
            gotoModale(){
               this.dialog=true 
            }
            ,
            enregistrement () {
                ...
                this.ajouterBeneficiaire(this.formData)
                if(this.getterErrorBeneficiaire==false){
...
modification(item){
this.modificationBeneficiaire(item)
},
      editItem (item) {
       this.edite=item
      ...
      deleteItemConfirm (item) {
        ...
        this.supprimerBeneficiaire(item.id)
      },
