    ...
    <v-main>
      ...
      <v-dialog v-model="dialogDelete" max-width="290">
        <v-card>
          ...
          <v-card-text
            >Voulez vous réellement effectuer cette action ?</v-card-text
          >
...
export default {
  ...
  computed: {
    ...mapGetters("Application", [
      ...
      "getterLoadingFonctionLocale",
      "getterErrorFonctionLocale",
    ]),
    formTitle() {
  ...
  methods: {
    ...mapActions("Application", [
      "ajouterFonctionLocale",
      "supprimerFonctionLocale",
      "modificationFonctionLocale",
    ]),
    gotoModale() {
      this.dialog = true;
    },
