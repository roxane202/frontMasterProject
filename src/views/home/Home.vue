                  ...
                  <table class="tbl-typical">
                    ...
                    <tr>
                      ...
                      <td class="color-blue-grey" nowrap align="center">
                        <span class="semibold">Today</span> 8:30
                      </td>
                    </tr>
                    <tr>
                      <td>
                      ...
                      <td align="center">3435362</td>
                      <td class="color-blue-grey" nowrap align="center">
                        <span class="semibold">Today</span> 16:30
                      </td>
                    </tr>
                    <tr>
                      <td>
                      ...
                      <td align="center">3435362</td>
                      <td class="color-blue-grey" nowrap align="center">
                        <span class="semibold">Yesterday</span>
                      </td>
                    </tr>
                    <tr>
                      <td>
                  ...
                  <article class="comment-item">
                    <div class="user-card-row">
                      <div class="tbl-row">
                        ...
                        <div class="tbl-cell">
                          <span class="user-card-row-name">
                            <a href="#">Matt McGill</a>
                          </span>
                        </div>
                    ...
                    <article class="contact-row">
                      <div class="user-card-row">
                        <div class="tbl-row">
                          ...
                          <div class="tbl-cell">
                            <p class="user-card-row-name">
                              <a href="#">Maggy Smith</a>
                            </p>
                            <p class="user-card-row-mail">
                              <a href="#">maggysmith@mail.com</a>
                            </p>
                          </div>
                    ...
                    <article class="contact-row">
                      <div class="user-card-row">
                        <div class="tbl-row">
                          ...
                          <div class="tbl-cell">
                            <p class="user-card-row-name">
                              <a href="#">Molly Bridjet</a>
                            </p>
                            <p class="user-card-row-mail">
                              <a href="#">mollybr@mail.com</a>
                            </p>
                          </div>
