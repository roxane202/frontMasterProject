<template>
  <v-app>
    ...
    <v-main>
      ...
      <!--DIALOG LOADING--->
      <v-dialog v-model="getterLoadingNatureIndicateur" persistent width="250" height="200">
...
export default {
  ...
  computed: {
    ...mapGetters("Application", [
      "getterNatureIndicateur",
      "getterLoadingNatureIndicateur",
      "getterErrorNatureIndicateur"
    ]),
    formTitle() {
  ...
  methods: {
    ...mapActions("Application", [
      "ajouterNatureIndicateur",
      "supprimerNatureIndicateur",
      "modificationNatureIndicateur"
    ]),
    gotoModale() {
      this.dialog = true;
    },
