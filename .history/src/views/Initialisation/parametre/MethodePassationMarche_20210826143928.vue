<template>
  <v-app>
    ...
    <v-main>
      ...
      <!--DIALOG LOADING--->
      <v-dialog v-model="getterLoadingMethodePassationMarche" persistent width="250" height="200">
...
export default {
  ...
  computed: {
    ...mapGetters("Application", [
      "getterMethodePassationMarche",
      "getterLoadingMethodePassationMarche",
      "getterErrorMethodePassationMarche"
    ]),
    formTitle() {
  ...
  methods: {
    ...mapActions("Application", [
      "ajouterMethodePassation",
      "supprimerMethodePassation",
      "modificationMethodePassation"
    ]),
    gotoModale() {
      this.dialog = true;
    },
