<template>
  <v-app>
    ...
    <v-main>
              ...
              <v-card>
                ...
                <v-card-text>
                  ...
                  <div class="form-group">
                    ...
                    <input
                      type="text"
                      :class="{ 'hasErroInpu': $v.formData.sigle.$error }"
                    ...
                    <div
                      style="color: red;"
                      class
                      v-if="$v.formData.sigle.$error"
                    >Veillez entrer le sigle</div>
                  </div>
      ...
      <!--DIALOG LOADING--->
      <v-dialog v-model="getterLoadingFournisseurs" persistent width="250" height="200">
...
export default {
  ...
  computed: {
    ...mapGetters("Application", [
      "getterFournisseurs",
      "getterLoadingFournisseurs",
      "getterErrorFournisseurs"
    ]),
    formTitle() {
