<template>
  <v-app>
    ...
    <v-main>
                  ...
                  <li class="nav-item">
                    ...
                    >
                      <span class="nav-link-in">
                        Resource Humaine
                        <span
                          class="label label-pill label-success"
                        >{{getterUsers.length}}</span>
                      </span>
                    </a>
                  </li>
                  <li class="nav-item" v-for="item in listeResourceDiffRH" :key="item.id">
                    ...
                    >
                      <span class="nav-link-in">
                        ...
                        <span
                          class="label label-pill label-success"
                        >{{listeResource(item.id).length}}</span>
                      </span>
                    </a>
                  </li>
                </ul>
                ...
                <table id="table-sm" class="table table-bordered table-hover table-sm">
                  ...
                  <tbody>
                    <tr v-for="user in getterUsers" :key="user.id">
                      ...
                      <td>
                        <v-icon small class="mr-2" @click="editItem(user)">mdi-pencil</v-icon>
                ...
                <table id="table-sm" class="table table-bordered table-hover table-sm">
                  ...
                  <tbody>
                    <tr v-for="resource in listeResource(item.id)" :key="resource.id">
                      ...
                      <td>
                        <v-icon small class="mr-2" @click="editItem(resource)">mdi-pencil</v-icon>
                        <v-icon small @click="deleteItem(resource)">mdi-delete</v-icon>
                      </td>
                    </tr>
                  </tbody>
                </table>
              ...
              <v-card>
                ...
                <v-card-text>
                  ...
                  <div class="form-group">
                    ...
                    <select
                      id="type"
                      :class="{ 'hasErroInpu': $v.formData.type_resource_id.$error }"
                      class="form-control"
                    ...
                    >
                      ...
                      >{{projetPartie.libelle}}</option>
                    </select>
                    <div
                      style="color: red;"
                      class
                      v-if="$v.formData.type_resource_id.$error"
                    >Veillez entrer le type de resource</div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    >Veillez entrer le nom ou désignation</div>
                  </div>
                    ...
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <select
                          id="fonction"
                          class="form-control"
                          v-model="formData.fonction_locale_id"
                        >
      ...
      <!--DIALOG LOADING--->
      <v-dialog v-model="getterLoadingResource" persistent width="250" height="200">
