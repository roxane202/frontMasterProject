...
<!--DIALOG LOADING--->
        <v-dialog
              v-model="getterLoadingAutrePartenaire"
              persistent
              width="250"
              height="200"
            >
     ...
     dialogEdite: false,
      ...
      defaultItem: {
       code: '',
        ...
        computed:{
            ...mapGetters('Application', ['getterAutrePartenaire', 'getterLoadingAutrePartenaire',"getterErrorAutrePartenaire"]),
              formTitle () {
        ...
        methods:{
             ...mapActions('Application', ['ajouterAutrePartenaire',"supprimerAutrePartenaire","modificationAutrePartenaire"]),
            gotoModale(){
               this.dialog=true 
            }
            ,
