        ...
        <template v-slot:default="dialog">
          <v-card>
            ...
            <v-card-actions class="justify-end">
              ...
              >Fermer</v-btn>
              <v-btn
            :disabled="getterLoadingTypeResource"
      :loading="getterLoadingTypeResource"
      class="white--text"
...
<!--DIALOG LOADING--->
        <v-dialog
              v-model="getterLoadingTypeResource"
              persistent
              width="250"
              height="200"
            >
     ...
     dialogEdite: false,
      ...
      defaultItem: {
       code: '',
        ...
        computed:{
            ...mapGetters('Application', ['getterTypeResource', 'getterLoadingTypeResource',"getterErrorTypeResource"]),
              formTitle () {
        ...
        methods:{
             ...mapActions('Application', ['ajouterTypeResource',"supprimerTypeResource","modificationTypeResource"]),
            gotoModale(){
               this.dialog=true 
            }
            ,
            enregistrement () {
                ...
                this.ajouterTypeResource(this.formData)
                if(this.getterErrorTypeResource==false){
...
modification(item){
this.modificationTypeResource(item)
},
      editItem (item) {
       this.edite=item
      ...
      deleteItemConfirm (item) {
        ...
        this.supprimerTypeResource(item.id)
      },
