...
<v-app>
 ...
 <v-data-table
    :headers="headers"
    :items="getterMethodePassationMarche"
    sort-by="code"
    class="elevation-1"
  >
        ...
        <template v-slot:default="dialog">
          <v-card>
            ...
            <v-card-actions class="justify-end">
              ...
              >Fermer</v-btn>
              <v-btn
                :disabled="getterLoadingMethodePassationMarche"
                :loading="getterLoadingMethodePassationMarche"
                class="white--text"
...
<!--DIALOG LOADING--->
        <v-dialog
              v-model="getterLoadingMethodePassationMarche"
              persistent
              width="250"
              height="200"
            >
     ...
     dialogEdite: false,
      ...
      defaultItem: {
       code: '',
        ...
        computed:{
            ...mapGetters('Application', ['getterMethodePassationMarche', 'getterLoadingMethodePassationMarche',"getterErrorMethodePassationMarche"]),
              formTitle () {
        ...
        methods:{
             ...mapActions('Application', ['ajouterMethodePassation',"supprimerMethodePassation","modificationMethodePassation"]),
            gotoModale(){
               this.dialog=true 
            }
            ,
            enregistrement () {
                ...
                this.ajouterMethodePassation(this.formData)
                if(this.getterErrorMethodePassationMarche==false){
...
modification(item){
this.modificationMethodePassation(item)
},
      editItem (item) {
       this.edite=item
      ...
      deleteItemConfirm (item) {
        ...
        this.supprimerMethodePassation(item.id)
      },
