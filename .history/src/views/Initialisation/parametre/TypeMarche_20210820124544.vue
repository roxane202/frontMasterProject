        ...
        <template v-slot:default="dialog">
          <v-card>
            ...
            <v-card-actions class="justify-end">
              ...
              >Fermer</v-btn>
              <v-btn
            :disabled="getterLoadingTypeMarche"
      :loading="getterLoadingTypeMarche"
      class="white--text"
...
<!--DIALOG LOADING--->
        <v-dialog
              v-model="getterLoadingTypeMarche"
              persistent
              width="250"
              height="200"
            >
     ...
     dialogEdite: false,
      ...
      defaultItem: {
       code: '',
        ...
        computed:{
            ...mapGetters('Application', ['getterTypeMarche', 'getterLoadingTypeMarche',"getterErrorTypeMarche"]),
              formTitle () {
        ...
        methods:{
             ...mapActions('Application', ['ajouterTypeMarche',"supprimerTypeMarche","modificationTypeMarche"]),
            gotoModale(){
               this.dialog=true 
            }
            ,
            enregistrement () {
                ...
                if(this.getterErrorTypeMarche==false){
...
modification(item){
this.modificationTypeMarche(item)
},
      editItem (item) {
       this.edite=item
      ...
      deleteItemConfirm (item) {
        ...
        this.supprimerTypeMarche(item.id)
      },
