        ...
        <template v-slot:default="dialog">
          <v-card>
            ...
            <v-card-actions class="justify-end">
              ...
              >Fermer</v-btn>
              <v-btn
            :disabled="getterLoadingFonctionLocale"
      :loading="getterLoadingFonctionLocale"
      class="white--text"
...
<!--DIALOG LOADING--->
        <v-dialog
              v-model="getterLoadingFonctionLocale"
              persistent
              width="250"
              height="200"
            >
     ...
     dialogEdite: false,
      ...
      defaultItem: {
       code: '',
        ...
        computed:{
            ...mapGetters('Application', ['getterFonctionLocale', 'getterLoadingFonctionLocale',"getterErrorFonctionLocale"]),
              formTitle () {
        ...
        methods:{
             ...mapActions('Application', ['ajouterFonctionLocale',"supprimerFonctionLocale","modificationFonctionLocale"]),
            gotoModale(){
               this.dialog=true 
            }
            ,
            enregistrement () {
                ...
                this.ajouterFonctionLocale(this.formData)
                if(this.getterErrorFonctionLocale==false){
...
modification(item){
this.modificationFonctionLocale(item)
},
      editItem (item) {
       this.edite=item
      ...
      deleteItemConfirm (item) {
        ...
        this.supprimerFonctionLocale(item.id)
      },
