        ...
        <template v-slot:default="dialog">
          <v-card>
            ...
            <v-card-actions class="justify-end">
              ...
              >Fermer</v-btn>
              <v-btn
            :disabled="getterLoadingDevise"
      :loading="getterLoadingDevise"
      class="white--text"
     ...
     dialogEdite: false,
      ...
      defaultItem: {
       code: '',
        ...
        computed:{
            ...mapGetters('Application', ['getterDevise', 'getterLoadingDevise',"getterErrorDevise"]),
              formTitle () {
        ...
        methods:{
             ...mapActions('Application', ['ajouterDevise',"supprimerDevise","modificationDevise"]),
            gotoModale(){
               this.dialog=true 
            }
            ,
            enregistrement () {
                ...
                this.ajouterDevise(this.formData)
                console.log(this.getterErrorDevise)
                if(this.getterErrorDevise==false){
