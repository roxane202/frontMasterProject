        ...
        <template v-slot:default="dialog">
          <v-card>
            ...
            <v-card-actions class="justify-end">
              ...
              >Fermer</v-btn>
              <v-btn
                :disabled="getterLoadingNatureIndicateur"
                :loading="getterLoadingNatureIndicateur"
                class="white--text"
...
<!--DIALOG LOADING--->
        <v-dialog
              v-model="getterLoadingNatureIndicateur"
              persistent
              width="250"
              height="200"
            >
     ...
     dialogEdite: false,
      ...
      defaultItem: {
       code: '',
        ...
        computed:{
            ...mapGetters('Application', ['getterNatureIndicateur', 'getterLoadingNatureIndicateur',"getterErrorNatureIndicateur"]),
              formTitle () {
        ...
        methods:{
             ...mapActions('Application', ['ajouterNatureIndicateur',"supprimerNatureIndicateur","modificationNatureIndicateur"]),
            gotoModale(){
               this.dialog=true 
            }
            ,
            enregistrement () {
                ...
                this.ajouterNatureIndicateur(this.formData)
                if(this.getterErrorNatureIndicateur==false){
...
modification(item){
this.modificationNatureIndicateur(item)
},
      editItem (item) {
       this.edite=item
      ...
      deleteItemConfirm (item) {
        ...
        this.supprimerNatureIndicateur(item.id)
      },
