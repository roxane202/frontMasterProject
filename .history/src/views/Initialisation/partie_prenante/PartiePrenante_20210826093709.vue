                     ...
                     <div class="col-md-4">
                         <div class="form-group">
                                <label class="form-label semibold" for="role">Rôle</label>
                                    <input type="text" :class="{ 'hasErroInpu': $v.formData.role.$error }" v-model="formData.role" name="role" class="form-control" id="role" placeholder="Rôle">
...
<div class="col-md-3">
 <div class="form-group">
                                <label class="form-label semibold" for="telephone">Télephone</label>
                                    <input type="text" :class="{ 'hasErroInpu': $v.formData.telephone.$error }" v-model="formData.telephone" name="telephone" class="form-control" id="telephone" placeholder="telephone">
...
<div class="col-md-3">
    <div class="form-group">
                                <label class="form-label semibold" for="email">Email</label>
                                    <input type="text" :class="{ 'hasErroInpu': $v.formData.email.$error }" v-model="formData.email" name="email" class="form-control" id="email" placeholder="email">
                                    <div style="color: red;" class="" v-if="$v.formData.email.$error">
                                        Veillez entrer le email
                                    </div>
                        </div>
</div>
<div class="col-md-3">
                <div class="form-group">
                                <label class="form-label semibold" for="email">Adresse</label>
                                    <input type="text" :class="{ 'hasErroInpu': $v.formData.adresse.$error }" v-model="formData.adresse" name="adresse" class="form-control" id="adresse" placeholder="adresse">
                                    <div style="color: red;" class="" v-if="$v.formData.adresse.$error">
                                        Veillez entrer l'adresse
                                    </div>
                        </div>
</div>
    ...
    <div class="col-md-3">
             <div class="form-group">
                                <label class="form-label semibold" for="puissance">Pussance pouvoir/intérêt</label>
                                    <input type="text" style="background-color:#2e3599;color:#fff !important" disabled v-model="formData.puissance" name="puissance" class="form-control" id="puissance" placeholder="puissance">
    ...
    <div class="col-md-3">
        <div class="form-group">
                                <label class="form-label semibold" for="puissance">Attitude</label>
                                    <input type="text" style="background-color:#2e3599;color:#fff !important" disabled v-model="formData.attitude" name="puissance" class="form-control" id="puissance" placeholder="">
     ...
     <div class="col-md-4">
                        <div class="form-group">
                              ...
                              <select id="Pour/Contre" class="form-control" v-model="formData.pour_contre">
								<option></option>
     ...
     <div class="col-md-4">
         <div class="form-group">
                              ...
                              <select id="Pour/Contre" class="form-control" v-model="formData.position_actuelle_id">
								<option></option>
								<option :value="item.id" v-for="item in getterPosition" :key="item.id">{{item.libelle}}</option>
							</select>
          </div>
    </div>
     ...
     <div class="col-md-4">
          <div class="form-group">
                              ...
                              <select id="Pour/Contre" class="form-control" v-model="formData.position_future_id">
								<option></option>
								<option :value="item.id" v-for="item in getterPosition" :key="'PS'+item.id">{{item.libelle}}</option>
							</select>
                         </div>
    </div>
                </div>
            ...
            <v-card-text>
                ...
                <div class="row">
                     ...
                     <div class="col-md-4">
                         <div class="form-group">
                                <label class="form-label semibold" for="role">Rôle</label>
                                    <input type="text"  v-model="edite.role" name="role" class="form-control" id="role" placeholder="Role">
...
<div class="col-md-3">
 <div class="form-group">
                                <label class="form-label semibold" for="telephone">Télephone</label>
                                    <input type="text"  v-model="edite.telephone" name="telephone" class="form-control" id="telephone" placeholder="telephone">
...
<div class="col-md-3">
    <div class="form-group">
                                <label class="form-label semibold" for="email">Email</label>
                                    <input type="text" v-model="edite.email" name="email" class="form-control" id="email" placeholder="email">
...
<div class="col-md-3">
                <div class="form-group">
                                <label class="form-label semibold" for="email">Adresse</label>
                                    <input type="text" v-model="edite.adresse" name="adresse" class="form-control" id="adresse" placeholder="adresse">
    ...
    <div class="col-md-3">
             <div class="form-group">
                                <label class="form-label semibold" for="puissance">Pussance pouvoir/intérêt</label>
                                    <input type="text" style="background-color:#2e3599;color:#fff !important" disabled v-model="edite.puissance" name="puissance" class="form-control" id="puissance" placeholder="puissance">
    ...
    <div class="col-md-3">
        <div class="form-group">
                                <label class="form-label semibold" for="puissance">Attitude</label>
                                    <input type="text" style="background-color:#2e3599;color:#fff !important" disabled v-model="edite.attitude" name="puissance" class="form-control" id="puissance" placeholder="">
     ...
     <div class="col-md-4">
         <div class="form-group">
                              <label class="form-label semibold" for="Pour/Contre">Position actuelle</label>
                              <select id="Pour/Contre" class="form-control" v-model="edite.position_actuelle_id">
								<option></option>
								<option :value="item.id" v-for="item in getterPosition" :key="item.id">{{item.libelle}}</option>
							</select>
                         </div>
     ...
     <div class="col-md-4">
          <div class="form-group">
                              <label class="form-label semibold" for="Pour/Contre">Position future</label>
                              <select id="Pour/Contre" class="form-control" v-model="edite.position_future_id">
								<option></option>
								<option :value="item.id" v-for="item in getterPosition" :key="'PS'+item.id">{{item.libelle}}</option>
							</select>
                         </div>
...
import { mapGetters, mapActions} from 'vuex'
     ...
     dialogEdite: false,
      ...
      defaultItem: {
       code: '',
        ...
        computed:{
            //edite_
            ...mapGetters('Application', ["getterPosition",'getterPartiePrenanteProjet', 'getterLoadingPartiePrenanteProjet',"getterErrorPartiePrenanteProjet"]),
             calculePussancePouvoireInteret(){
                 let vm=this
              ...
              edite_calculePussancePouvoireInteret(){
                 ...
                 vm.edite.puissance=parseFloat(vm.edite.pouvoir)* parseFloat(vm.edite.interet)
                 }
  ...
  edite_determineAttitude(){
        ...
        methods:{
             ...mapActions('Application', ['ajouterPartiePrenante',"supprimerPartiePrenante","modificationPartiePrenanteProjet"]),
            gotoModale(){
               this.dialog=true 
            }
            ,
