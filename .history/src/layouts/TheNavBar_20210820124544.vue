...
...mapMutations('parametrageMenu', ['activate']),
 ...mapActions('Application', ['getProjet',"getPartiePrenante","getTypeResource",
 "getResource","getPoidsIndicateur","getAutrePartenaire","getNatureIndicateur",
 "getBeneficiaire","getTypeMarche","getMethodePassation",
 "getFournisseur","getDevise","getFonctionLocale","getPosition","getProjetPartiePrenante","getUser"]),
			afficheMenu(value){
	this.activate(value)
			}
        }
